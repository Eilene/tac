...
def network_multi_classes_dev(genre):
    ...
    # 训练
    print 'Train...'
    model = network_fit(x_train, y_train, 2)  # 分三类
    ...
    print probabilities
    y_predict_nn = predict_by_proba_3classes_threshold(probabilities, 0.3, 0.3)  # 这个阈值该咋调呢。。
    # 测试文件根据打分过滤掉none的样本
    ...
    print 'Net predict labels: ', y_predict_nn
    ...
    y_predict_df.to_csv(dev_y_predict_dir+'network_network_proba_y_predict.csv', index=False)
