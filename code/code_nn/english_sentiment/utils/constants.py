...
pred_ere_test_df_entity_info_dir = '../../../data/output/english_sentiment/middle_files_pred_ere_test/df/entity_info/'
pred_ere_test_df_relation_info_dir = '../../../data/output/english_sentiment/middle_files_pred_ere_test/df/relation_info/'
pred_ere_test_df_event_info_dir = '../../../data/output/english_sentiment/middle_files_pred_ere_test/df/event_info/'
pred_ere_test_df_em_args_dir = '../../../data/output/english_sentiment/middle_files_pred_ere_test/df/em_args/'
pred_ere_test_nw_entity_info_dir = '../../../data/output/english_sentiment/middle_files_pred_ere_test/nw/entity_info/'
pred_ere_test_nw_relation_info_dir = '../../../data/output/english_sentiment/middle_files_pred_ere_test/nw/relation_info/'
pred_ere_test_nw_event_info_dir = '../../../data/output/english_sentiment/middle_files_pred_ere_test/nw/event_info/'
pred_ere_test_nw_em_args_dir = '../../../data/output/english_sentiment/middle_files_pred_ere_test/nw/em_args/'
