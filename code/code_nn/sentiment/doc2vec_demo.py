...
def handle_imdb_dataset(sentiment):
    ...
    save_file = data_prefix + 'aclImdb/' + sentiment + ".txt"
    save_file_handler = open(save_file, 'w+')
    reviews = []
    for dt in data_type:
        imdb_dir = data_prefix + 'aclImdb/' + dt + "/" + sentiment
        print imdb_dir
        for parent, dirnames, filenames in os.walk(imdb_dir):
            print len(filenames)
            for filename in filenames:
                print filename
                with open((parent+'/'+filename), 'r') as infile:
...
pos_file = data_prefix + 'aclImdb/pos.txt'
neg_file = data_prefix + 'aclImdb/neg.txt'
unsup_file = data_prefix + 'aclImdb/unsup.txt'
