...
from src.english_belief.features.general_features import *
...
def regression_test(genre):
    ...
    if genre is True:
        filepath = '../../../data/output/english_belief/general_features_test_df.csv'
    else:
        filepath = '../../../data/output/english_belief/general_features_test_nw.csv'
