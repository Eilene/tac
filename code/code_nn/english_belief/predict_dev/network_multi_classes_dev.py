...
from src.english_belief.models.network_fit import *
from src.english_belief.features.general_features import gen_general_features
...
def network_multi_classes_dev(genre):
    ...
    # import pandas as pd
    # if genre is True:
    #     filepath = '../../../data/output/english_belief/general_features_dev_df.csv'
    # else:
    #     filepath = '../../../data/output/english_belief/general_features_dev_nw.csv'
