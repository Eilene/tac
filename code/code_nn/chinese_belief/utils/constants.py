...
if use_predicted_ere is False:
    ...
    test_df_entity_info_dir = '../../../data/output/chinese_belief/middle_files_pred_ere_test/df/entity_info/'
    test_df_relation_info_dir = '../../../data/output/chinese_belief/middle_files_pred_ere_test/df/relation_info/'
    test_df_event_info_dir = '../../../data/output/chinese_belief/middle_files_pred_ere_test/df/event_info/'
    test_df_em_args_dir = '../../../data/output/chinese_belief/middle_files_pred_ere_test/df/em_args/'
    test_nw_entity_info_dir = '../../../data/output/chinese_belief/middle_files_pred_ere_test/nw/entity_info/'
    test_nw_relation_info_dir = '../../../data/output/chinese_belief/middle_files_pred_ere_test/nw/relation_info/'
    test_nw_event_info_dir = '../../../data/output/chinese_belief/middle_files_pred_ere_test/nw/event_info/'
    test_nw_em_args_dir = '../../../data/output/chinese_belief/middle_files_pred_ere_test/nw/em_args/'
...
if use_predicted_ere is False:
    ...
    test_df_predict_dir = '../../../data/output/chinese_belief/predict_test_r/df/'
    test_nw_predict_dir = '../../../data/output/chinese_belief/predict_test_r/nw/'
...
if use_predicted_ere is False:
    ...
    test_df_y_predict = '../../../data/output/chinese_belief/y_predict_test_r/df/'
    test_nw_y_predict = '../../../data/output/chinese_belief/y_predict_test_r/nw/'
...
if use_predicted_ere is False:
    ...
    doctext_path = '../../../data/output/chinese_belief/doctext_r.txt'
    docmodel_path = '../../../data/output/chinese_belief/doc2vec_model_200_r.txt'