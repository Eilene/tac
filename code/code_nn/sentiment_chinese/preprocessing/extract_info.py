...
from src.sentiment_chinese.utils.split_sentences import *
from src.sentiment_chinese.utils.constants import *
            ...
            if annotation_filepath != '':
                ...
                for k in range((len(annotation_entity_list))):
                    ...
                    if annotation_entity_id == entity_mention_id:
                        ...
                        #                 " " + relation_mention_id)
                        label_polarity = st_em[0].getAttribute('polarity')  # 这说明都有么
                        break
            ...
            for m in range((len(entity_mention_list))):
                ...
                if rel_arg_mention_id == entity_mention_id:
                    ...
                    if rel_arg_context_dict is not None:
                        ...
                        sen = ''
                        sen_offset = 0
                    # 出现了在标签中，作者作为一个参数的情况，此时dict为none
